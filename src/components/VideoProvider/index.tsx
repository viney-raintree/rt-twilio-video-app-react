...
import useWhiteBoardToggle from './useWhiteBoardToggle/useWhiteBoardToggle';
...
export function VideoProvider({ options, children, onError = () => {} }: VideoProviderProps) {
  ...
  const [isWhiteBoardOpen, toggleWhiteBoard, whiteBoardUrl, setIframeUrl, setWBValue] = useWhiteBoardToggle(room, localTracks, onError);
